...
class WorkspaceTaskAdapter(val context: Context, val isSystem: Boolean) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            VIEW_TYPE_WORKSPACE -> WorkspaceHolder(LayoutRowItemWorkspaceTitleBinding.inflate(inflater, parent, false))
            VIEW_TYPE_TASK -> TaskHolder(LayoutRowItemTaskCheckTitleBinding.inflate(inflater, parent, false))
            VIEW_TYPE_EMPTY -> EmptyHolder(LayoutRowItemEmptyBinding.inflate(inflater, parent, false))
    ...
    inner class TaskHolder(var binding: LayoutRowItemTaskCheckTitleBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    inner class WorkspaceHolder(var binding: LayoutRowItemWorkspaceTitleBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    inner class EmptyHolder(var binding: LayoutRowItemEmptyBinding) : RecyclerView.ViewHolder(binding.root) {
